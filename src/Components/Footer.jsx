...
const Footer = () => {
  ...
  return (
    <>
      ...
      >
        <div className="h-[30vh] bg-primary hidden medium:flex text-white  justify-evenly  p-10  ">
        ...
        <div className="h-[50vh] bg-primary flex-col flex medium:hidden medium:h-[30vh] text-white  justify-center items-center p-10 ">
